...
using UnityEngine;
using System;
public class ObjectPool : MonoSingeleton<ObjectPool>
{
    ...
    for(int k = 0; k < pools[poolIndex].pooledObject.Count; k++) { //kullanılmayan bir objeyi getirsin diye  ekstra bir kod ekledim
